            ...
            <div class="container mx-auto flex justify-between items-center">
                ...
                @auth
                    <nav class="flex gap-2 items-center">
                        <a class="font-bold text-gray-600 text-sm" href="{{route('post.index',auth()->user())}}">
                            Hola: <span class="font-normal ">{{auth()->user()->username}}</span>
                        </a>

                        <a 
                            class="flex items-center gap-2 bg-white border p-2 
                                text-gray-600 rounded uppercase font-bold cursor-pointer text-sm" href="{{route('posts.create')}}">
